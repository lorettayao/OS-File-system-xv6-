...
0000000000000a60 <main>:
{
    ...
    while (getcmd(buf, sizeof(buf)) >= 0)
     ...
     a9c:	a0048493          	addi	s1,s1,-1536 # 1498 <buf.0>
        if (buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' ')
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
            if (chdir(buf + 3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	9f3a0a13          	addi	s4,s4,-1549 # 149b <buf.0+0x3>
    ...
    while (getcmd(buf, sizeof(buf)) >= 0)
     ...
     b36:	96650513          	addi	a0,a0,-1690 # 1498 <buf.0>
...
0000000000000e6a <get_force_fail>:
...
0000000000000e8a <force_disk_fail>:
...
static void putc(int fd, char c) { write(fd, &c, 1); }
     ...
     eb8:	f2e080e7          	jalr	-210(ra) # de2 <write>
...
void *malloc(uint nbytes)
{
    ...
    1310:	b3e080e7          	jalr	-1218(ra) # e4a <sbrk>
    if (p == (char *)-1)
